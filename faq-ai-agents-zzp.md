...
In het eerste startgesprek bepalen we welke taak, toegang en inrichting nodig zijn. Daarna ontvang je vooraf één vaste prijs voor het afgesproken starttraject. Geen open urenrekening en geen verrassingen achteraf. Reken voor het inrichten van een eerste afgebakende Hermes-assistent op ongeveer €1.000 exclusief btw. Wil je Hermes op een Europese VPS laten draaien, reken dan doorgaans op ongeveer €10 tot €20 per maand exclusief btw, afhankelijk van de server en eventuele extra’s. Met een bestaand ChatGPT Plus-abonnement met Codex kom je meestal al erg ver en heb je een goede LLM als basis. In Nederland kost dat momenteel ongeveer €23 per maand inclusief btw. Daarnaast richten we veel goedkopere commoditymodellen in als fallback. Bij normaal gebruik blijven de kosten daarvan vaak onder €10 per maand, maar het exacte bedrag hangt af van het daadwerkelijke verbruik. Er is geen verplicht beheerabonnement.
...
Daarom begint ZZPagent/MKBAgents niet met technologie, maar met procesanalyse: waar zit het hoogste ROI-potentieel, welke taak komt vaak terug, welke data is gezond genoeg en waar blijft menselijke controle nodig? Een goede pilot loopt meestal in **4–8 weken**: van concreet bedrijfsprobleem naar een werkende agent met meetbare resultaten. De route, self-hosted, Europese cloud of hybride, stemmen we af op je datastrategie.
